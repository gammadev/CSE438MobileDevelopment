...
class RecommendedViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        self.title = "Movies Like: " + movieTitle
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "pushDetail2" {
    ...
    func fetchMovieData() {
        let json = getJSON("https://api.themoviedb.org/3/movie/" + movieID + "/recommendations?api_key=732fa3547ac0c8854e6cb8051027d15a&language=en-US&page=1")
        print(json)
        print(movieID)
